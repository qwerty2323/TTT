...
describe Position do
	...
	context "#win_lines" do
		it "should find winnig columns, row, diagonals" do
	...
	context "#evaluate_leaf" do
		...
		it "should determine won position for x" do			
		  Position.new(%w(x - -
		  				  o x -
		  				  o - x)).evaluate_leaf.should == 100
		end
		it "should determine won position for o" do			
		  Position.new(%w(o x -
		  				  o x -
		  				  o - x), "o").evaluate_leaf.should == -100
		end
		it "should determine blocked position" do			
		  Position.new(%w(o x x
		  				  x x o
		  				  o o x)).evaluate_leaf.should == 0
		end
	end
	context "#minimax" do
